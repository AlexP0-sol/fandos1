...
Полное руководство оператора (все экраны, каждая настройка, аварийные механизмы, API):
**[`docs/MANUAL.md`](fandos1/docs/MANUAL.md)**.
Работа в VS Code (открытие папки, готовые конфиги, запуск и отладка):
**[`docs/VSCODE.md`](fandos1/docs/VSCODE.md)**.
